...
dir.create("results/tree_objects",             showWarnings = FALSE)  
...
# alignment and divergence time filters
...
# range overlap as a binary sympatric term
...
# single-tree analysis (for testing)
...
report_checkpoint_status <- function(n_trees, class_names) {
  ...
  if (completed == 0) {
    ...
    cat(sprintf("  Found checkpoints — will resume from tree %d.\n",
