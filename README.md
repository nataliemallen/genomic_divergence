1. first, run the nextflow pipeline in run_genomes_and_alignment. Requires input file with target genomes, outputs genome alignment files and k2p divergence calculation
